package  {
	...
	public class SoundManager {
		...
		public function crossFade(fadeOutId:String, fadeInId:String, tweenDuration:Number = 2, fadeInVolume:Number = 1, fadeInRepetitions:int = 1):void {			
			...
			if(fadeOutId!=null) tweenVolume (fadeOutId, 0, tweenDuration);
			if(fadeInId!=null) tweenVolume (fadeInId, fadeInVolume, tweenDuration);
			   
			// stop the fade-out sound when its volume reaches zero
			if(fadeOutId!=null) Starling.juggler.delayCall(stopSound, tweenDuration, fadeOutId);
		}
